...
class ICsteam(nn.Module):
    def __init__(self):
        ...
        self.b1_2 = Block1(64, 32)

        self.b2_1 = Block2(32, 32)
        self.b2_2 = Block2(32, 32)
        self.b2_3 = Block2(32, 32)
...
class DCAM(nn.Module):
    def __init__(self, inchannels1=32, inchannels2=16, outchannels=32):
        ...
        self.blk = nn.Sequential(
            nn.Conv2d(inchannels1 + inchannels2, outchannels, kernel_size=1, padding=0),
    ...
    def forward(self, inputs1, inputs2):  # inputs1 noise inputs2 content
        ...
        x = torch.cat((inputs2, x_RN), dim=1)
        x = self.blk(x)
        output = self.att2(x)
        return output
...
class TS_PRE_GFC(nn.Module):
    def __init__(self, outchannels=32):
        ...
        self.dcam = DCAM(inchannels1=32, inchannels2=32, outchannels=32)
