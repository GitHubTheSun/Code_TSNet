...
def train(model, train_set, valid_set, test_set, save, seed=None):
    ...
    '''
    n_epochs = 200
    optimizer = torch.optim.SGD(model_wrapper.parameters(), lr=0.05, weight_decay=0.0005,
                                momentum=0.9)
...
def demo(batch_size=16, seed=None):
    ...
    # train_path = 'D:\shiyao_DataSet\Dataset\BOSSBase_256\S_UNIWARD\\train_boss_BOSW2\SUN-0.4'
    # test_path = 'D:\shiyao_DataSet\Dataset\BOSSBase_256\S_UNIWARD\\test_boss\SUN-0.4'
    # valid_path = 'D:\shiyao_DataSet\Dataset\BOSSBase_256\S_UNIWARD\\valid_boss\SUN-0.4'

    # train_path = 'D:\shiyao_DataSet\Dataset\BOSSBase_256\HILL\\train_boss_BOSW2\HILL-0.3'
    # test_path = 'D:\shiyao_DataSet\Dataset\BOSSBase_256\HILL\\test_boss\HILL-0.3'
    # valid_path = 'D:\shiyao_DataSet\Dataset\BOSSBase_256\HILL\\valid_boss\HILL-0.3'
    ...
    # train_path = 'D:\shiyao_DataSet\Dataset\BOSSBase_256\WOW\\train_boss_BOSW2\WOW-0.4'
    # test_path = 'D:\shiyao_DataSet\Dataset\BOSSBase_256\WOW\\test_boss\WOW-0.4'
    # valid_path = 'D:\shiyao_DataSet\Dataset\BOSSBase_256\WOW\\valid_boss\WOW-0.4'
    ...
    # save = 'C:\\Users\Lenovo\Desktop\第三个工作实验记录\EXP\\消融实验\\ISTSNet32_32_sun04'
    save = 'G:\\transportresult\\ISTSNet\\wow04'
    print("log保存路径：", save)
